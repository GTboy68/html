...
$conf['settings']['host'] = 'srv-ldap-001.alpaca.int'; // comma separated list of ldap servers such as mydomain1,localhost
...
$conf['settings']['binddn'] = 'sa_ldap_ti_01@ap.be';	// The distinguished name to bind as (username). If you don't supply this, an anonymous bind will be established.
$conf['settings']['bindpw'] = 'DlfN55b8yf6O8IJRDjIn';	// Password for the binddn. If the credentials are wrong, the bind will fail server-side and an anonymous bind will be established instead. An empty bindpw string requests an unauthenticated bind.
$conf['settings']['basedn'] = 'ou=users,ou=DWAP,DC=alpaca,DC=int';	// LDAP base name (eg. dc=example,dc=com)
