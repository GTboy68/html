...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['InsufficientPermissionsError'] = 'You do not have permission to access this Classroom';
		$strings['MissingReservationResourceError'] = 'A Classroom was not selected';
		...
		$strings['AllResources'] = 'All Classrooms';
		...
		$strings['ResourceCapacity'] = 'This Classroom has a capacity of %s people';
		$strings['ResourceCapacityNone'] = 'This Classroom has unlimited capacity';
		$strings['AddNewResource'] = 'Add New Classroom';
		$strings['AddNewUser'] = 'Add New User';
		$strings['AddUser'] = 'Add User';
		$strings['Schedule'] = 'Schedule';
		$strings['AddResource'] = 'Add Classroom';
		...
		$strings['ResourcePermissions'] = 'Classroom Permissions';
		...
		$strings['ReservationTitle'] = 'Exam Title';
		$strings['ReservationDescription'] = 'Extra information';
		$strings['ResourceList'] = 'Classrooms to be reserved';
		$strings['Accessories'] = 'Teachers';
		$strings['ParticipantList'] = 'Participants';
		$strings['InvitationList'] = 'Invitees';
		$strings['AccessoryName'] = 'Teacher Name';
		$strings['QuantityAvailable'] = 'Quantity Available';
		$strings['Resources'] = 'Classrooms';
		$strings['Participants'] = 'Participants';
		$strings['User'] = 'User';
		$strings['Resource'] = 'Classroom';
		...
		$strings['ReservationRequiresApproval'] = 'One or more of the Classrooms reserved require approval before usage.  This reservation will be pending until it is approved.';
		...
		$strings['MoreResources'] = 'More Classrooms';
		...
		$strings['AddResources'] = 'Add Classrooms';
		$strings['AddAccessories'] = 'Add Teachers';
		$strings['Accessory'] = 'Teacher';
		...
		$strings['DeleteAccessoryWarning'] = 'Deleting this Teacher will remove it from all reservations.';
		$strings['AddAccessory'] = 'Add Teacher';
		$strings['AddBlackout'] = 'Add Blackout';
		$strings['AllResourcesOn'] = 'All Classrooms On';
		...
		$strings['DeleteGroupWarning'] = 'Deleting this group will remove all associated Classroom permissions.  Users in this group may lose access to Classrooms.';
		...
		$strings['DeleteResourceWarning'] = 'Deleting this Classroom will delete all associated data, including';
		...
		$strings['AddUser'] = 'Add User';
		$strings['UserPermissionInfo'] = 'Actual access to Classroom may be different depending on user role, group permissions, or external permission settings';
		...
		$strings['MoveResourcesAndReservations'] = 'Move Classrooms and reservations to';
		...
		$strings['NoResourceAdministratorLabel'] = '(No Classroom Administrator)';
		$strings['WhoCanManageThisResource'] = 'Who Can Manage This Classroom?';
		$strings['ResourceAdministrator'] = 'Classroom Administrator';
		...
		$strings['AllAccessories'] = 'All Teachers';
		...
		$strings['ReservedResources'] = 'Reserved Classrooms';
		$strings['ReservedAccessories'] = 'Reserved Teachers';
		$strings['ResourceUsageTimeBooked'] = 'Classroom Usage - Time Booked';
		$strings['ResourceUsageReservationCount'] = 'Classroom Usage - Reservation Count';
		...
		$strings['ResourceFilter'] = 'Classroom Filter';
		$strings['ResourceGroups'] = 'Classroom Groups';
		...
		$strings['ResourceGroupHelp1'] = 'Drag and drop Classroom groups to reorganize.';
		$strings['ResourceGroupHelp2'] = 'Right click a Classroom group name for additional actions.';
		$strings['ResourceGroupHelp3'] = 'Drag and drop Classrooms to add them to groups.';
		$strings['ResourceGroupWarning'] = 'If using Classroom groups, each Classroom must be assigned to at least one group. Unassinged Classrooms will not be able to be reserved.';
		$strings['ResourceType'] = 'Classroom Type';
		$strings['AppliesTo'] = 'Applies To';
		$strings['UniquePerInstance'] = 'Unique Per Instance';
		$strings['AddResourceType'] = 'Add Classroom Type';
		$strings['NoResourceTypeLabel'] = '(no Classroom type set)';
		...
		$strings['ResourceStatus'] = 'Classroom Status';
		$strings['CurrentStatus'] = 'Current Status';
		$strings['AllReservationResources'] = 'All Reservation Classrooms';
		$strings['File'] = 'File';
		$strings['BulkResourceUpdate'] = 'Bulk Classroom Update';
		...
		$strings['ConflictingAccessoryDates'] = 'these Teachers are currently unavailable:';
		$strings['NoResourcePermission'] = 'You do not have permission to access one or more of the requested classrooms.';
		...
		$strings['ManageResources'] = 'Classrooms & Teachers';
		$strings['ManageAccessories'] = 'Teachers';
		...
		$strings['MyCalendar'] = 'My Calendar';
		$strings['ResourceCalendar'] = 'Classroom Calendar';
		...
		$strings['ResourceReservations'] = 'Classroom Reservations';
		...
		$strings['ManageResourceGroups'] = 'Classroom Groups';
		$strings['ManageResourceTypes'] = 'Classroom Types';
		$strings['ManageResourceStatus'] = 'Classroom Statuses';
		// End Page Titles
