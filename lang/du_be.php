...
class du_be extends en_us
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['InsufficientPermissionsError'] = 'U hebt onvoldoende rechten tot deze lokaal';
        $strings['MissingReservationResourceError'] = 'Er werd geen lokaal geselecteerd';
        ...
        $strings['AllResources'] = 'Alle lokalen';
        ...
        $strings['ResourceCapacity'] = 'Dit lokaal heeft een capaciteit van %s personen';
        $strings['ResourceCapacityNone'] = 'Dit lokaal heeft ongelimiteerde capaciteit';
        $strings['AddNewResource'] = 'Nieuw lokaal toevoegen';
        $strings['AddNewUser'] = 'Nieuwe gebruiker toevoegen';
        $strings['AddUser'] = 'Gebruiker toevoegen';
        $strings['Schedule'] = 'Planning';
        $strings['AddResource'] = 'lokaal toevoegen';
        ...
        $strings['Search'] = 'Zoek';
        $strings['ResourcePermissions'] = 'Toegangsrechten lokaal';
        ...
        $strings['ReservationTitle'] = 'Examen titel';
        $strings['ReservationDescription'] = 'Extra informatie';
        $strings['ResourceList'] = 'Te reserveren lokalen';
        $strings['Accessories'] = 'Lectoren';
        $strings['Add'] = 'Voeg toe';
        $strings['ParticipantList'] = 'Deelnemers';
        $strings['InvitationList'] = 'Uitgenodigden';
        $strings['AccessoryName'] = 'Naam Lectoren';
        $strings['QuantityAvailable'] = 'Aantal';
        $strings['Resources'] = 'Lokalen';
        $strings['Participants'] = 'Deelnemers';
        $strings['User'] = 'Gebruiker';
        $strings['Resource'] = 'Lokaal';
        ...
        $strings['MoreResources'] = 'Extra lokalen';
        ...
        $strings['AddResources'] = 'Voeg lokaal toe';
        $strings['AddAccessories'] = 'Voeg lectoren toe';
        $strings['Accessory'] = 'Lectoren';
        $strings['QuantityRequested'] = 'Kies';
        ...
        $strings['DeleteAccessoryWarning'] = 'Deze lectoren verwijderen betekent dat deze uit alle reserveringen verwijderd zal worden.';
        $strings['AddAccessory'] = 'Voeg Lectoren toe';
        $strings['AddBlackout'] = 'Voeg geblokkeerde periode toe';
        $strings['AllResourcesOn'] = 'Alle lokalen op';
        ...
        $strings['DeleteGroupWarning'] = 'Deze groep verwijderen resulteert in het verwijderen van alle gekoppelde toegangsrechten op lokalen. Gebruikers in deze groep kunnen derhalve toegangsrechten verliezen.';
        ...
        $strings['DeleteResourceWarning'] = 'Deze lokaal verwijderen resulteert in het verwijderen van alle gelinkte informatie';
        ...
        $strings['AddUser'] = 'Gebruiker toevoegen';
        $strings['UserPermissionInfo'] = 'De concrete toegang tot de lokalen hangt af van uw rol, groepsrechten en externe toegangsrechten.';
		...
		$strings['MoveResourcesAndReservations'] = 'Verplaats lokalen en reserveringen naar';
		...
		$strings['NoResourceAdministratorLabel'] = '(Geen Lokalen Administrator)';
		$strings['WhoCanManageThisResource'] = 'Wie kan deze Lokaal beheren?';
		$strings['ResourceAdministrator'] = 'Lokaal Administrator';
		...
		$strings['AllAccessories'] = 'Alle lectoren';
		...
		$strings['ReservedResources'] = 'Gereserveerde Lokalen';
		$strings['ReservedAccessories'] = 'Gereserveerde lectors';
		$strings['ResourceUsageTimeBooked'] = 'Lokalen gebruik - Tijd Geboekt';
		$strings['ResourceUsageReservationCount'] = 'Lokalen gebruik - Gereserveerd Aantal';
		...
		$strings['ResourceFilter'] = 'Lokaal Filter';
		$strings['ResourceGroups'] = 'Lokaal Groepen';
		...
		$strings['ResourceGroupHelp1'] = 'Slepen naar lokaal groepen om te reorganiseren.';
		$strings['ResourceGroupHelp2'] = 'Klik rechts op een lokaal groepsnaam voor extra acties.';
		$strings['ResourceGroupHelp3'] = 'Sleep naar lokaal om toe te voegen aan de groepen.';
		$strings['ResourceGroupWarning'] = 'Als je lokaal groepen gebruikt zal elke lokaal toegewezen moeten worden aan minstens een groep. Lokalen die niet zijn toegewezen kunnen niet gereserveerd worden.';
		$strings['ResourceType'] = 'Lokaal Type';
		$strings['AppliesTo'] = 'Toepassen Pp';
		$strings['UniquePerInstance'] = 'Unieke Per Instantie';
		$strings['AddResourceType'] = 'Voeg Lokaal Type Toe';
		$strings['NoResourceTypeLabel'] = '(geen lokaal type geselecteerd)';
		...
		$strings['ResourceStatus'] = 'Lokaal Status';
		$strings['CurrentStatus'] = 'Huidige Status';
		$strings['AllReservationResources'] = 'Alle Reservatie lokalen';
		$strings['File'] = 'Bestand';
		$strings['BulkResourceUpdate'] = 'Bulk Lokaal update';
        ...
        $strings['ConflictingAccessoryDates'] = 'Deze lector is momenteel niet beschikbaar:';
        $strings['NoResourcePermission'] = 'U hebt onvoldoende rechten om toegang tot een of meerdere van de lokalen te verkrijgen';
        ...
        $strings['ManageResources'] = 'Lokalen & docenten';
        $strings['ManageAccessories'] = 'Lectoren';
        ...
        $strings['MyCalendar'] = 'Mijn kalender';
        $strings['ResourceCalendar'] = 'Lokaal kalender';
		...
		$strings['ResourceReservations'] = 'Lokaal Reservaties';
		...
		$strings['ManageResourceGroups'] = 'Lokaal Groepen';
		$strings['ManageResourceTypes'] = 'Lokaal Types';
		$strings['ManageResourceStatus'] = 'Lokaal Statussen';
        //
