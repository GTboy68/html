<?php /* Smarty version Smarty-3.1.16, created on 2015-02-22 16:56:11
         compiled from "C:\xampp\htdocs\tpl\Schedule\schedule-week-condensed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2553854e9fc1b7d7480-22446799%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5eb8fb0039bb513a4877dcd437d52aa56170ec9b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tpl\\Schedule\\schedule-week-condensed.tpl',
      1 => 1420035436,
      2 => 'file',
    ),
    'c567f9b08b365218628aebb7c6031230cb2702b1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tpl\\Schedule\\schedule.tpl',
      1 => 1420035436,
      2 => 'file',
    ),
    '6f2f8d27a39626b494710a6b2267798bf4c3b03f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tpl\\globalheader.tpl',
      1 => 1420035436,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2553854e9fc1b7d7480-22446799',
  'function' => 
  array (
  ...
  'unifunc' => 'content_54e9fc1bcd4b24_18087856',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54e9fc1bcd4b24_18087856')) {function content_54e9fc1bcd4b24_18087856($_smarty_tpl) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('globalheader.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('cssFiles'=>'css/jquery.qtip.min.css,scripts/css/jqtree.css,css/schedule.css'), 0, '2553854e9fc1b7d7480-22446799');
content_54e9fc1b913b44_29024512($_smarty_tpl);
...
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['href'] = new Smarty_variable($_tmp3."?rid=".((string)$_smarty_tpl->tpl_vars['resourceId']->value)."&sid=".((string)$_smarty_tpl->tpl_vars['ScheduleId']->value), null, 0);?>
				<tr class="slots">
...
?>
						...
						<?php if ($_smarty_tpl->tpl_vars['summary']->value->NumberOfReservations()>0) {?>
							<td class="reserved clickres slot" date="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['date']->value,'key'=>'url'),$_smarty_tpl);?>
" resourceId="<?php echo $_smarty_tpl->tpl_vars['resourceId']->value;?>
" resid="<?php echo $_smarty_tpl->tpl_vars['summary']->value->FirstReservation()->ReferenceNumber();?>
">
								<?php echo $_smarty_tpl->tpl_vars['summary']->value->NumberOfReservations();?>
 <?php if ($_smarty_tpl->tpl_vars['summary']->value->NumberOfReservations()==1) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'reservation'),$_smarty_tpl);?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'reservations'),$_smarty_tpl);?>
<?php }?>
							</td>
						<?php } else { ?>
							<?php ob_start();?><?php echo Pages::RESERVATION;?>
...
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['href'] = new Smarty_variable($_tmp4."?rid=".((string)$_smarty_tpl->tpl_vars['resource']->value->Id)."&sid=".((string)$_smarty_tpl->tpl_vars['ScheduleId']->value)."&rd=".$_tmp5, null, 0);?>
							<td class="reservable clickres slot" ref="<?php echo $_smarty_tpl->tpl_vars['href']->value;?>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.16, created on 2015-02-22 16:56:11
         compiled from "C:\xampp\htdocs\tpl\globalheader.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54e9fc1b913b44_29024512')) {function content_54e9fc1b913b44_29024512($_smarty_tpl) {?><!DOCTYPE html>
